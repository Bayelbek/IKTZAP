...
import AdminNews from './components/pages/admin/News/index.jsx';
import Update from './components/pages/admin/update/index.tsx';
import AddCategory from './components/pages/admin/addCategory/index.js';
import AddSubCategory from './components/pages/admin/addSubCategory/index.tsx';
import AddProduct from './components/pages/admin/addProduct/index.tsx';
      ...
      <Router>
        <Routes>
          ...
          <Route path="/adminPanel/*" element={<AdminPanel />}>
            ...
            <Route path="category/:id" element={<Update/>} />
